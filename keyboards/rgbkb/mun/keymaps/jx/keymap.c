...
*/
    [_LOWER] = LAYOUT(
        ...
        _______, _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,S(KC_NUHS),KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
        _______, _______, _______, TCH_TOG, _______, _______, _______, _______, ADJUST,  KC_PAGE_UP, KC_VOLD, KC_VOLU, KC_PAGE_DOWN,
