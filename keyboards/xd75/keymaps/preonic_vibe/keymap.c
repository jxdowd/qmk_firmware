 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_SPC,  KC_LCTL, KC_LALT, KC_LGUI, MO(_LW), KC_SPC,  KC_SPC,  MO(_RS), KC_LEFT, KC_UP,   KC_DOWN, KC_RIGHT, KC_P0,   KC_PDOT, MO(_FN)  },
 },
 ...
 */
 ...
 [_LW] = { /* LOWERED */
  ...
  { _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_MPRV, KC_MPLY, KC_MNXT, ___T___, ___T___, _______, _______  },
  { M(0),    _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_VOLU, KC_VOLD, KC_END,  _______, _______, _______  },
 },
 ...
 */
 ...
 [_RS] = { /* RAISED */
  ...
  { _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_MPRV, KC_MPLY, KC_MNXT, ___T___, ___T___, _______, _______  },
  { M(0),    _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_VOLU, KC_VOLD, KC_END,  _______, _______, ___T___  },
 },
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | RGB TG | RGB MD | RGB HI | RGB HD | RGB SI | RGB SD | RGB VI | RGB VD | BL TOG | BL INC | BL DEC | XXXXXX |        |        | WHEEL- |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  { KC_NLCK, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  ___T___, RESET    },
  { KC_SLCK, KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24,  _______, KC_PSCR  },
  { KC_CAPS, KC_BTN5, KC_BTN4, KC_BTN3, KC_BTN2, KC_ACL0, KC_ACL2, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, KC_PAUS, ___T___, ___T___, KC_WH_U  },
  { RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, BL_TOGG, BL_INC,  BL_DEC,  ___T___, ___T___, _______, KC_WH_D  },
  { ___T___, _______, DF(_QW), _______, _______, KC_BTN1, KC_BTN1, _______, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R, _______, _______, _______  },
 },
};
