 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | N      | M      | ,      | .      | /      | ENTER  | 0      | UP     | DEL    |
 * |--------+--------+--------+--------+--------+- 2u ------------+--------+--------+--------+--------+-----------------+--------+--------|
 * |        | LCTRL  | LALT   | LGUI   | RAISE  | XXXXXX . SPACE  | LOWER  | RGUI   | RALT   | RCTRL  | FN     | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,  KC_P0,   KC_UP,   KC_DEL   },
 ...
 * |        | F1     | F2     | F3     | F4     | F5     | F6     | _      | +      | {      | }      | |      |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | F7     | F8     | F9     | F10    | F11    | F12    |        |  Prev  |  Play  |  Next  |        |        |  VOL+  |  DEL   |
 * |--------+--------+--------+--------+--------+- 2u ------------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        |        |        | XXXXXX .        |        |        |        |        |        |  HOME  |  VOL-  |  END   |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_LW] = { /* LOWERED */
  ...
  { _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_MPRV, KC_MPLY, KC_MNXT, ___T___, ___T___, KC_VOLU, _______  },
  { M(0),    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_VOLD, KC_END   },
 },
 ...
 * |        | F1     | F2     | F3     | F4     | F5     | F6     | -      | =      | [      | ]      | \      |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | F7     | F8     | F9     | F10    | F11    | F12    |        |  Prev  |  Play  |  Next  |        |        |  Vol+  |        |
 * |--------+--------+--------+--------+--------+- 2u ------------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        |        |        | XXXXXX .        |        |        |        |        |        |  HOME  |  Vol-  |  END   |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { RESET  , _______, DF(_QW), _______, _______, KC_BTN1, KC_BTN1, _______, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R  },
 },
};
